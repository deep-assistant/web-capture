...
const htmlResponse = await fetch(`${baseUrl}/html?url=${encodeURIComponent(targetUrl)}&engine=playwright`);
...
const imageResponse = await fetch(`${baseUrl}/image?url=${encodeURIComponent(targetUrl)}&engine=playwright`);
